...
def main():
    ...
    for i, z in enumerate(z_list):
        ...
        res, settings = read_data('_pl_sejm' + cfg.suffix, input_dir='results/final2/')
    ...
    axs[1, 1].set_ylim([0.975, 5.02])
    axs[1, 1].set_yticks((1, 3, 5))
    axs[1, 1].set_yticklabels((1, 3, 5))
    ...
    axs[3, 1].set_ylim([0.975, 5.02])
    axs[3, 1].set_yticks((1, 3, 5))
    axs[3, 1].set_yticklabels((1, 3, 5))
