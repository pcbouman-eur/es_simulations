...
def main():
    ...
    plot_box(res['data'], labels=eps_list_100, file_name=f'{param}_box_{short.lower()}.pdf', title=short, number='b', ylabel='fraction of seats', xlabel=r'$\varepsilon$ [$\times 10^{-2}$]', ylim=(-0.03, 1.03))
    ...
    plot_box(res['data'], labels=eps_list_100, file_name=f'{param}_box_{short.lower()}.pdf', title=short, number='c', ylabel='fraction of seats', xlabel=r'$\varepsilon$ [$\times 10^{-2}$]', ylim=(-0.03, 1.03))
