...
def main():
    ...
    plot_box(res['data'], labels=parties_list, file_name=f'{param}_box_{short.lower()}.pdf', title=short, number='b', ylabel='election result', xlabel=f'number of {param}', ylim=(-0.03, 1.03))
    ...
    plot_box(res['data'], labels=parties_list, file_name=f'{param}_box_{short.lower()}.pdf', title=short, number='c', ylabel='election result', xlabel=f'number of {param}', ylim=(-0.03, 1.03))
